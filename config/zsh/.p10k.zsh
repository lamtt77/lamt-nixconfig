# Generated by Powerlevel10k configuration wizard on 2025-09-20 at 21:50 AEST.
...
# compact, many icons, concise, transient_prompt, instant_prompt=auto-quiet.
...
() {
  ...
  # Tmux indicator segment
  function prompt_tmux() {
    if [[ -n $TMUX ]]; then
      p10k segment -f cyan -t 'T'
    fi
  }
