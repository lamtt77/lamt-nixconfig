    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('User', {
        ...
        callback = function(args)
          vim.keymap.set('n', 'gh', function() MiniFiles.open(vim.fn.expand('~')) end, { buffer = args.data.buf_id, desc = 'Go to home directory' })
          vim.keymap.set('n', 'g/', function() MiniFiles.open('/') end, { buffer = args.data.buf_id, desc = 'Go to root directory' })
          vim.keymap.set('n', 'ge', function() MiniFiles.open('/etc') end, { buffer = args.data.buf_id, desc = 'Go to /etc directory' })
          vim.keymap.set('n', 'gu', function() MiniFiles.open('/usr') end, { buffer = args.data.buf_id, desc = 'Go to /usr directory' })
          vim.keymap.set('n', 'gv', function() MiniFiles.open('/var') end, { buffer = args.data.buf_id, desc = 'Go to /var directory' })
          vim.keymap.set('n', 'go', function() MiniFiles.open('/opt') end, { buffer = args.data.buf_id, desc = 'Go to /opt directory' })
      ...
      vim.keymap.set("n", "<leader>-", ":lua MiniFiles.open()<CR>", { desc = "Open parent directory (mini.files)" })
