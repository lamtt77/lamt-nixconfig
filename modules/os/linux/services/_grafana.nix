                    ...
                    targets = [
                      {
                        ...
                        editorMode = "code";
                        expr = ''
                          zfs_dataset_used_bytes{name="tank"} / zfs_dataset_available_bytes{name="tank"}'';
                        hide = false;
                        legendFormat = "{{name}}";
                        range = true;
                        refId = "A";
                    ...
                    targets = [
                      {
                        ...
                        exemplar = false;
                        expr = ''
                          increase(http_requests_received_total{endpoint="Sessions/Playing"}[1d])'';
                        instant = false;
                        legendFormat = "Past Day";
                        range = true;
                        refId = "A";
                      }
                      {
                        ...
                        editorMode = "code";
                        expr = ''
                          increase(http_requests_received_total{endpoint="Sessions/Playing"}[7d])'';
                        hide = false;
                        legendFormat = "Past Week";
                        range = true;
                        refId = "B";
                      }
                      {
                        ...
                        editorMode = "code";
                        expr = ''
                          increase(http_requests_received_total{endpoint="Sessions/Playing"}[30d])'';
                        hide = false;
                        legendFormat = "Past Month";
                        range = true;
                        refId = "C";
                    ...
                    targets = [
                      {
                        ...
                        exemplar = false;
                        expr = ''
                          sort_desc(max(irate(node_cpu_seconds_total{instance="127.0.0.1:${
                            builtins.toString
                            config.services.prometheus.exporters.node.port
                          }",mode=~"system|user"}[$__range])) by (job))'';
                        instant = true;
                        legendFormat = "__auto";
                        range = false;
                        refId = "A";
                    ...
                    targets = [
                      {
                        ...
                        exemplar = false;
                        expr = ''
                          sort_desc((node_filesystem_size_bytes{mountpoint="/"} - node_filesystem_avail_bytes{mountpoint="/"}) / node_filesystem_size_bytes{mountpoint="/"})'';
                        instant = true;
                        legendFormat = "{{job}}";
                        range = false;
                        refId = "A";
                    ...
                    targets = [
                      {
                        ...
                        editorMode = "code";
                        expr = ''
                          max(irate(node_cpu_seconds_total{job="$host",instance="127.0.0.1:${
                            builtins.toString
                            config.services.prometheus.exporters.node.port
                          }",mode=~"system|user"}[$__range]))'';
                        hide = false;
                        legendFormat = "CPU";
                        range = true;
                        refId = "C";
                      }
                      {
                        ...
                        editorMode = "code";
                        expr = ''
                          (node_memory_Active_bytes{job="$host"})/node_memory_MemTotal_bytes{job="$host"}'';
                        hide = false;
                        legendFormat = "Memory";
                        range = true;
                        refId = "B";
                      }
                      {
                        ...
                        exemplar = false;
                        expr = ''
                          (node_filesystem_size_bytes{mountpoint="/",job="$host"} - node_filesystem_avail_bytes{mountpoint=~"/",job="$host"}) / node_filesystem_size_bytes{mountpoint="/",job="$host"}'';
                        instant = true;
                    ...
                    targets = [
                      {
                        ...
                        exemplar = false;
                        expr = ''
                          topk(5, irate(namedprocess_namegroup_cpu_seconds_total{job="$host"}[$__range]))'';
                        instant = true;
                    ...
                    targets = [
                      {
                        ...
                        exemplar = false;
                        expr = ''
                          topk(5, rate(namedprocess_namegroup_memory_bytes{memtype="resident",job="$host"}[$__range]))'';
                        instant = true;
                        legendFormat = "{{groupname}}";
                        range = false;
                        refId = "A";
